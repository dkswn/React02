 ...
 export const SELECTCOMMENTS = "SelectMembersComment/SELECTCOMMENTS";
 export const addTodo = (payload) => {
  return { type:SELECTCOMMENTS,payload};
 };
...
// Reducer
const SelectMembersComment = (state = initialState, action) => {
    console.log("리듀서 호출");
    switch(action.type) {
        case SELECTCOMMENTS:
            return {
                ...state,
          lists:  [...state.SelectMembersComment,action.payload],
        };
            default:
                return state;
...
export default SelectMembersComment;
